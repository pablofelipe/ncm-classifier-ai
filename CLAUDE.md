...
- Public deployment (Fly.io/Railway): deterministic Docker build, Chroma index baked into the image, no server-side LLM key (ADR-0016 already covers that constraint) — planned, not yet executed
