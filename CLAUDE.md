...
- **ADR-0012** — Local cross-encoder rerank (BGE/Jina/MS-MARCO): the ranking-precision lever, zero recurring API cost. Next: attacks the residual where lexical+dense both struggle (`frontier` 43.5%, `multi_attr` 45.5%, sibling juice leaves in Cap 20).
